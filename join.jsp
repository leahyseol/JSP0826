...
function winOpen() {
	...
	var childWindow = window.open('joinIdDupCheck.jsp', '', 'width=400,height=300');
}
...
<fieldset>
	...
	<label>User ID</label> <input name="id" type="text" class="id"> <input name="id 중복확인" type="button" value="dup. check" class="dup"><br>
